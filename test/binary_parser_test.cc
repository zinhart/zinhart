...
{
  using namespace zinhart::file_io;
  csv_format fmt;
  fmt.set_delimeters('#',',','\n');
...
TEST(binary_parser_test, binary)
{
  /*
...
TEST(binary_parser_test, mnist_test)
{
/*  using namespace zinhart;
  fstream strm;
...
TEST(binary_parser_test,mnist_train)
{
/*  using namespace zinhart;
  fstream strm;
  binary_parser<BIN> prep;
...
TEST(binary_parser_test,mnist_test_label)
{
/*  using namespace zinhart;
  fstream strm;
...
TEST(binary_parser_test,mnist_train_label)
{
/*  using namespace zinhart;
  fstream strm;
