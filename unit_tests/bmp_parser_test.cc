...
TEST(bitmap_parser_test,mnist_test)
{
  /*
  using namespace zinhart;
  fstream strm;
...
TEST(bitmap_parser_test,mnist_train)
{
/*  using namespace zinhart;
  fstream strm;
  binary_parser<BIN> prep;
...
TEST(bitmap_parser_test,mnist_test_label)
{
/*  using namespace zinhart;
  fstream strm;
...
TEST(bitmap_parser_test,mnist_train_label)
{
/*  using namespace zinhart;
  fstream strm;
